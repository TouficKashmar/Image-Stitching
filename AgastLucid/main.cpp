...

{
    ...
    //Then, we create our feature descriptor, in this case we are using LUCID
    //We need to set the parameters of the LUCID detector
    //Through test and experiments, we determined the lucid_kernel = 9 while the blur_kernel = 2
    //These values also depend on the dimensions and quality of the image
    Ptr<LUCID> desc_comp = LUCID::create(9,2);
    Mat desc1, desc2;
